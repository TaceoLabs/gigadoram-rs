//! Cuckoo hash table construction and lookup.
//!
...
// TODO: Simplify, refactor and add comments to this code. It is currently a direct translation of the C++ builder code,
// and I'm pretty sure it is more complex than it needs to be.
pub fn build(
    stash_size: usize,
