...
pub use types::{
    ...
    bit_to_binary_mask, bit_to_y_mask, dummy_x, from_2_shares, input, open_many, open_many_y,
    open_y, promote_public, promote_public_values, promote_public_y, promote_public_y_values,
